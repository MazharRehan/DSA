...
{ //Line 5
	...
	cout << "Line 11: The top element of intStack: "<< intStack.top() << endl; //Line 11
	intStack.pop(); //Line 12
	cout << "Line 13: After the pop operation, the top element of intStack: " << intStack.top() << endl; //Line 13
